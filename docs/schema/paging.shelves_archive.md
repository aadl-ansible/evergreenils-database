...
| ---- | ---- | ------- | -------- | -------- | ------- | ------- |
| id | bigint | nextval('paging.shelves_archive_id_seq'::regclass) | false |  |  |  |
...
| ---- | ---- | ---------- |
| shelves_archive_pkey | PRIMARY KEY | PRIMARY KEY (id) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| shelves_archive_pkey | CREATE UNIQUE INDEX shelves_archive_pkey ON paging.shelves_archive USING btree (id) |

## Relations

![er](paging.shelves_archive.svg)
