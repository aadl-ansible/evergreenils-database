...
| ---- | ---- | ---------- |
| serial_unit_history_pkey | PRIMARY KEY | PRIMARY KEY (audit_id) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| serial_unit_history_pkey | CREATE UNIQUE INDEX serial_unit_history_pkey ON auditor.serial_unit_history USING btree (audit_id) |
| aud_serial_unit_hist_creator_idx | CREATE INDEX aud_serial_unit_hist_creator_idx ON auditor.serial_unit_history USING btree (creator) |
| aud_serial_unit_hist_editor_idx | CREATE INDEX aud_serial_unit_hist_editor_idx ON auditor.serial_unit_history USING btree (editor) |

## Relations

![er](auditor.serial_unit_history.svg)
