...
```sql
CREATE VIEW wide_display_entry AS (
...
| title | text |  | true |  |  |  |
| author | text |  | true |  |  |  |
| subject_geographic | text |  | true |  |  |  |
| subject_name | text |  | true |  |  |  |
| subject_temporal | text |  | true |  |  |  |
| subject_topic | text |  | true |  |  |  |
| creators | text |  | true |  |  |  |
| isbn | text |  | true |  |  |  |
| issn | text |  | true |  |  |  |
| upc | text |  | true |  |  |  |
| tcn | text |  | true |  |  |  |
| edition | text |  | true |  |  |  |
| physical_description | text |  | true |  |  |  |
| publisher | text |  | true |  |  |  |
| series_title | text |  | true |  |  |  |
| abstract | text |  | true |  |  |  |
| toc | text |  | true |  |  |  |
| pubdate | text |  | true |  |  |  |
| type_of_resource | text |  | true |  |  |  |
...
![er](metabib.wide_display_entry.svg)
