...
| ---- | ---- | ---------- |
| items_pro_pkey | PRIMARY KEY | PRIMARY KEY (item_id) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| items_pro_pkey | CREATE UNIQUE INDEX items_pro_pkey ON statsmagic.items_pro USING btree (item_id) |
| bibnumber_pro | CREATE INDEX bibnumber_pro ON statsmagic.items_pro USING btree (bibnumber) |
| call_number_pro | CREATE INDEX call_number_pro ON statsmagic.items_pro USING btree (call_number) |
| last_checkout_pro | CREATE INDEX last_checkout_pro ON statsmagic.items_pro USING btree (last_checkout) |

## Relations

![er](statsmagic.items_pro.svg)
